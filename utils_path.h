...
struct object3D *
newPlane(double diffPct, double reflPct, double tranPct, double r, double g, double b, double refl_sig, double r_index);
...
void
planeIntersect(struct object3D *plane, struct ray3D *r, double *lambda, struct point3D *p, struct point3D *n, double *a,
               double *b);

void sphereIntersect(struct object3D *sphere, struct ray3D *r, double *lambda, struct point3D *p, struct point3D *n,
                     double *a, double *b);
