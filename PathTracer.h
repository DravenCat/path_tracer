...
struct ray3D {
    ...
    int insideOut; //1 from air to obj, 0 from obj to air
};
...
struct object3D {
    ...
    // has been provided
    void (*intersect)(struct object3D *obj, struct ray3D *ray, double *lambda, struct point3D *p, struct point3D *n,
                      double *a, double *b);
    ...
    int LSidx;    //index of light source object in object_list, 0 means no idx assigned to current LS.
};
